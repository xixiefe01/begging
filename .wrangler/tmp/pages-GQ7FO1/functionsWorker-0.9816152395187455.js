...
// v1/_middleware.js
var AGNES_BASE = "https://apihub.agnes-ai.com/v1";
async function onRequest(context) {
  ...
  try {
    const resp = await fetch(agnesUrl, {
      ...
      headers,
      body: request.method === "POST" ? body : void 0
    });
...
// img-proxy.js
var ALLOWED_HOSTS = ["agnes-ai.space", "agnes-ai.com"];
...
// ../.wrangler/tmp/pages-GQ7FO1/functionsRoutes-0.06924039119153624.mjs
var routes = [
  {
    routePath: "/v1",
    mountPath: "/v1",
